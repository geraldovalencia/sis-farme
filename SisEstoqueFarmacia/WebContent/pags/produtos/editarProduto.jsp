...
<title>Editar PRODUTO - SIS ESTOQUE FARMÁCIA</title>
<style>
#wrapper {
	width: 70%;
}
...
<body>
	...
	<div id="wrapper">
		<div id="login" align="center">
			...
			<form method='post' action='EditarProdutoServlet.du'>
	
			<input type='hidden' name='idProdutoAposEdicao' value='${produtoEditar != null ? produtoEditar.id : ""}'/>
					...
					<tr align='center'>
						...
						<td><div  class="form-group has-success has-feedback">
								<input type="text" class="form-control"
									id="inputSuccess2" name='novoProduto' required="true" 
									value='${produtoEditar != null ? produtoEditar.nome : ""}'/> <span
									class="glyphicon form-control-feedback">*</span>
							</div></td>
						<td><input style="width: 40%"  type='number' placeholder="QTD"
							class="form-control" name='qtde_estoque' required="true" 
							value='${produtoEditar != null ? produtoEditar.qtde_estoque : ""}'
							/></td>
						<td><input type='text' value='${produtoEditar != null ? produtoEditar.precovenda : ""}' name='preco' id="preco" class="form-control" required="true"/></td>
					</tr>
				</table>
				<table class='table tabelaCentro'>
				<tr>
				...
				<tr>
					<td><div  class="form-group">
								...
								value='${produtoEditar != null ? produtoEditar.numeroLoteMedicamento : ""}'  /> 
					</div></td>
					<td><div  class="form-group">
								<input type="text" class="form-control"
									id="registroMSMedicamento" name='registroMSMedicamento' required="true"
									value='${produtoEditar != null ? produtoEditar.registroMSMedicamento : ""}' /> 
					</div></td>
					<td><div  class="form-group">
								<input type="text" class="form-control"
									id="marca" name='marca' required="true"
									value='${produtoEditar != null ? produtoEditar.marca : ""}' />
					</div></td>
				</tr>
				</table>
				<br>
