...
<body>
	...
	<div id="wrapper">
		<div id="login" align="center">
			<h1>Novo FARMACÊUTICO</h1>
			<form method='get'
				action='/SisEstoqueFarmacia/TelaCadastroFarmaceutico.du'>
				...
				<div style="width: 60%">
					...
					<div class="form-group has-success has-feedback">
						...
						<div class="col-sm-10">
							<input type='text' size='10' required="true" maxlength="6" name='matricula' 
					...
					<div class="form-group has-success has-feedback">
						...
						<div class="col-sm-10">
							<input type='text' required="true" name='crf' id='crf'
